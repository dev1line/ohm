...
export class Olympus__epochResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class Olympus__warmupInfoResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: boolean;
...
export class Olympus extends ethereum.SmartContract {
  static bind(address: Address): Olympus {
    return new Olympus("Olympus", address);
  }
  ...
  epoch(): Olympus__epochResult {
    ...
    return new Olympus__epochResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_epoch(): ethereum.CallResult<Olympus__epochResult> {
    let result = super.tryCall(
      "epoch",
      "epoch():(uint256,uint256,uint256,uint256)",
      []
  ...
  warmupInfo(param0: Address): Olympus__warmupInfoResult {
    let result = super.call(
      "warmupInfo",
    ...
    return new Olympus__warmupInfoResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBoolean()
  ...
  try_warmupInfo(
    param0: Address
  ): ethereum.CallResult<Olympus__warmupInfoResult> {
    let result = super.tryCall(
      "warmupInfo",
      "warmupInfo(address):(uint256,uint256,uint256,bool)",
      [ethereum.Value.fromAddress(param0)]
